"""Ship LGB v3 to fteam11 and run."""
import os
import paramiko
...
sftp = t11.open_sftp()
try:
    for fname in ("predict_tvt_lgb_v3.py", "eval_lgb_v3_remote.py"):
        local = LOCAL / fname
...
print("\n=== run v3 eval ===")
run(f"cd {REMOTE} && python3 -u scripts/eval_lgb_v3_remote.py 2>&1 | tee logs/lgb_v3_eval.log", t=3600)
