"""Ship LGB v2 to fteam11 and run GroupKFold(5)."""
import os
import paramiko
...
sftp = t11.open_sftp()
try:
    for fname in ("predict_tvt_lgb_v2.py", "eval_lgb_v2_remote.py"):
        local = LOCAL / fname
...
print("\n=== run v2 eval ===")
run(f"cd {REMOTE} && python3 -u scripts/eval_lgb_v2_remote.py 2>&1 | tee logs/lgb_v2_eval.log", t=3600)
